...
@AnalyzeClasses(
        packages = "com.vetclinic.billing",
...
class ArchitectureTest {
    ...
    @ArchTest
    static final ArchRule billing_module_should_not_depend_on_other_modules =
            noClasses()
                    .that()
                    .resideInAPackage("com.vetclinic.billing..")
                    .should()
                    .dependOnClassesThat()
                    .resideInAnyPackage(
