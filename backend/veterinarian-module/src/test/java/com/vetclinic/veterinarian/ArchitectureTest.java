...
@AnalyzeClasses(
        packages = "com.vetclinic.veterinarian",
...
class ArchitectureTest {
    ...
    @ArchTest
    static final ArchRule veterinarian_module_should_not_depend_on_patient_module =
            noClasses()
                    .that()
                    .resideInAPackage("com.vetclinic.veterinarian..")
                    .should()
                    .dependOnClassesThat()
    ...
    @ArchTest
    static final ArchRule veterinarian_module_should_not_depend_on_client_module =
            noClasses()
                    .that()
                    .resideInAPackage("com.vetclinic.veterinarian..")
                    .should()
